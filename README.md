...
- [3. **数据分析**](#3-数据分析)
  ...
  - [3.2. **CCI指标**](#32-cci指标)
    ...
    - [3.2.2. **指标用法**](#322-指标用法)
    - [3.2.3. **公式**](#323-公式)
      - [3.2.3.1. **公式一：**](#3231-公式一)
      - [3.2.3.2. **公式二：**](#3232-公式二)
    - [3.2.4. **程序设计**](#324-程序设计)
    - [3.2.5. **参数说明**](#325-参数说明)
    - [3.2.6. **测试结果**](#326-测试结果)
  ...
  - [3.5. **分时数据 成交手分析**](#35-分时数据-成交手分析)
    - [3.5.1. **基本概念**](#351-基本概念)
    - [3.5.2. **分析的形态**](#352-分析的形态)
    - [3.5.3. **程序设计**](#353-程序设计)
    - [3.5.4. **参数说明**](#354-参数说明)
    - [3.5.5. **结果及分析**](#355-结果及分析)
...
![3.5.5](https://catsjuice.cn/index/src/markdown/stock/201905181224.png "3.5.5结果")
